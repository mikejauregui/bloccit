...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "reedirects to the new post" do
  ...
  describe "GET edit" do
    ...
    it "assigns post to be updated to @sponsored_postspost" do
      get :edit, topic_id: my_topic.id, id: my_sponsored_post.id
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
      ...
      put :update, topic_id: my_topic.id, id: my_sponsored_post.id, sponsored_post: {title: new_title, body: new_body, price: 15}
      ...
      expect(updated_sponsored_post.price).to eq 15
    end
